...
class TailTest(unittest.TestCase):
    ...
    def test_rejected_reply_is_transparent_only_to_accepted_descendants(self):
        root = message_id(1)
        ...
        self.assertEqual(terminal.tips(), {root, unrelated})

        self.write(descendant, [invalid_reply], "descendant")
        snapshot = self.snapshot()
        ...
        self.assertEqual(snapshot.tips(), {unrelated, descendant})
